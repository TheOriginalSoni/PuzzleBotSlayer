from utils.util import db_path, data_path, wordlist_path, corpus_path
from utils.normalize import slugify, unspaced_lower
from utils.regextools import is_exact, regex_len, regex_slice
